                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      ...
                      className="text-sm font-medium text-green-600 transition-colors hover:text-green-500 hover:underline"
                    >
                      Forgot password?
                    </Link>
                  </div>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center text-white px-16">
          <div className="max-w-xl">
            ...
            <p className="text-[19px] text-white/90 mb-8 text-left font-jakarta">
              Negari empowers you to raise your voice, track progress, and
              connect with local officials. Together, we make neighborhoods
              safer and stronger.
            </p>
            ...
            <div className="space-y-4 text-left">
              ...
              <div className="flex items-center">
                ...
                <span className="font-jakarta">
                  Priority checks for urgent reports
                </span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="font-jakarta">
                  Real-time updates & official responses
                </span>
              </div>
            </div>
          </div>
